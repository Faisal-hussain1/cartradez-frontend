  ...
  return (
    <div className='min-h-screen bg-background px-4 sm:px-6 md:px-8 py-10 sm:py-12'>
      <div className='max-w-4xl mx-auto mb-8 border-b border-primary pb-3 text-center sm:text-left'>
        <h2 className='text-4xl sm:text-3xl lg:text-4xl font-bold mb-2'>
          {faq.title}
        </h2>
        <p className='text-lg  sm:text-base'>{faq.subtitle}</p>
      </div>
      ...
      <div className='max-w-4xl mx-auto mb-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-3'>
        ...
        <button className='bg-primary hover:bg-primary cursor-pointer text-white px-5 py-3 rounded-lg flex items-center justify-center gap-2 transition w-full sm:w-auto text-sm sm:text-base'>
          <Search size={18} />
